...
function ProviderRegistration() {
  ...
  return (
    <div>
      ...
      <div
        className="flex flex-col gap-4 sm:justify-center items-center sm:py-0 py-8"
        style={{ height: "calc(100vh - 50px)" }}
      >
        <p className="font-semibold">
          Register with us to bring your tiffin service online
        </p>
        <div className="lg:w-1/3 md:w-2/5 sm:w-2/3 w-4/5">
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="logo" className="font-semibold text-slate-800">
                Add Logo
              </label>
              <input
                type="file"
                ...
                id="logo"
                required
                onChange={(e) => setProviderLogo(e.target.files)}
              />
            </div>
            <div
            ...
            >
              <input
                type="submit"
                value={`${isSigning ? "Signing..." : "Register"}`}
